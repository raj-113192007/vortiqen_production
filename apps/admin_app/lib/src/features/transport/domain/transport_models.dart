...
class StudentPassenger {
  ...
  final String status; // 'BOARDED 🟢' or 'NOT BOARDED (ABSENT 🔴)'
  final String parent;
  final String phone;
  ...
  bool get isBoarded => status.toUpperCase().contains('BOARDED') && !status.toUpperCase().contains('NOT');
}
...
class VehicleFleetInfo {
  ...
  bool get isMoving => liveStatus.toUpperCase().contains('MOVING');
  bool get isArrived => liveStatus.toUpperCase().contains('ARRIVED');
  ...
  static List<VehicleFleetInfo> getFleet() {
    return [
      VehicleFleetInfo(
        ...
        capacity: 42,
        routeName: 'Route 04: Dwarka Sec 12 ➔ School Campus',
        totalStops: 14,
        totalScholars: 38,
        onboardToday: 36,
        absentToday: 2,
        ...
        studentsOnboard: const [
          ...
          StudentPassenger(name: 'Rohan Mehta', studentClass: 'Class 10-A', stop: 'Janakpuri C-1', boardedTime: '--', status: 'NOT BOARDED (ABSENT 🔴)', parent: 'Sanjay Mehta', phone: '+91 98333 44556'),
          StudentPassenger(name: 'Kabir Kapoor', studentClass: 'Class 11-Sci', stop: 'Janakpuri B-Block', boardedTime: '--', status: 'NOT BOARDED (ABSENT 🔴)', parent: 'Anil Kapoor', phone: '+91 98555 66778'),
      ...
      VehicleFleetInfo(
        ...
        capacity: 36,
        routeName: 'Route 07: Rohini Sec 15 ➔ School Campus',
        totalStops: 12,
        totalScholars: 34,
        onboardToday: 33,
        absentToday: 1,
        ...
        studentsOnboard: const [
          ...
          StudentPassenger(name: 'Tanya Sengupta', studentClass: 'Class 12-Arts', stop: 'Punjabi Bagh Club', boardedTime: '--', status: 'NOT BOARDED (ABSENT 🔴)', parent: 'Subhash Sengupta', phone: '+91 98111 99001'),
        ],
        fuelLogs: const [
      ...
      VehicleFleetInfo(
        ...
        capacity: 26,
        routeName: 'Route 02: Vasant Kunj ➔ School Campus',
        totalStops: 10,
        totalScholars: 24,
        onboardToday: 24,
        absentToday: 0,
        ...
        nextServiceDate: '20 Sept 2026 (in 21 days ⚠️)',
        fitnessExpiry: '10 June 2027 (Valid)',
        insuranceExpiry: '10 Oct 2026 (Expires Soon ⚠️)',
