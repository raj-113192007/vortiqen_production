...
mixin _$AssetCategory {
 ...
 String get id; String get schoolId; String get name; String? get description; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,schoolId,name,description,createdAt,updatedAt);

@override
String toString() {
  return 'AssetCategory(id: $id, schoolId: $schoolId, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String schoolId, String name, String? description, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of AssetCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? schoolId = null,Object? name = null,Object? description = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String schoolId,  String name,  String? description,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssetCategory() when $default != null:
return $default(_that.id,_that.schoolId,_that.name,_that.description,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String schoolId,  String name,  String? description,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _AssetCategory():
return $default(_that.id,_that.schoolId,_that.name,_that.description,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String schoolId,  String name,  String? description,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AssetCategory() when $default != null:
return $default(_that.id,_that.schoolId,_that.name,_that.description,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _AssetCategory implements AssetCategory {
  const _AssetCategory({required this.id, required this.schoolId, required this.name, this.description, this.createdAt, this.updatedAt});
...
/// Create a copy of AssetCategory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? schoolId = null,Object? name = null,Object? description = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
